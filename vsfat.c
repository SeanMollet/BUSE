...
static void build_boot_sector()
{
  ...
  if(xmpl_debug){    
    ...
    fprintf(stderr,"BS 1: %u\n",part1_base);
    fprintf(stderr,"BS 2: %x\n",part1_base+bootentry.BPB_BkBootSec*bootentry.BPB_BytsPerSec);
  }
  
  //Main copy
  add_address_region(part1_base,512,&bootentry,0);
  add_address_region(part1_base+bootentry.BPB_BkBootSec*bootentry.BPB_BytsPerSec,512,&bootentry,0);  
}

static u_int64_t address_from_fatclus(u_int32_t fatclus)
{
  return (u_int64_t) part1_base + (u_int64_t) bootentry.BPB_BytsPerSec*bootentry.BPB_SecPerClus*fatclus;
}
...
static void build_fats()
{
  unsigned char fatspecial[] = {0xF8,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0x0F,0xF8,0xFF,0xFF,0x0F, //Special entries
    0xFF,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0x0F}; //My 3 files
...
//  0xF8,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0x0F,0xFF,0xFF,0xFF,0x0F};
  ...
  add_address_region(address_from_fatsec(fat_location(0)),bootentry.BPB_FATSz32*bootentry.BPB_BytsPerSec,fat,0);
  add_address_region(address_from_fatsec(fat_location(1)),bootentry.BPB_FATSz32*bootentry.BPB_BytsPerSec,fat,0);    
}


static void build_files()
{
  unsigned char filedata[] = {};
